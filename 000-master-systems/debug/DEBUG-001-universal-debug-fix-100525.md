---
name: universal-debug-fix-protocol
description: AI execution prompt for comprehensive auditable debugging with Taskwarrior tracking and evidence collection
model: opus
date: 2025-10-05
---

# Universal Debug-Fix Protocol
## AI Execution Prompt for Systematic Debugging

**Note:** This is an AI EXECUTION PROMPT that provides a complete systematic debugging workflow when previous fix attempts have failed.

---

## How to Use This Template

1. **Describe your bug** in the "Problem Description" section below
2. **Paste your code/prompt** in the "Code to Debug" section
3. **Copy this entire document** and send it to Claude Code
4. Claude will follow the complete auditable debug-fix protocol
...
## Code/Prompt to Debug

**PASTE YOUR CODE, PROMPT, OR CONFIGURATION HERE:**
...
## Quick Reference: Taskwarrior Commands

**Create tasks:**
```bash
task add project:$PROJECT "Task description"
```
...
**Export task data:**
```bash
task project:$PROJECT export > claudes-docs/tasks.json
```
...
After running this protocol, you will have:

1. **Complete reproduction** of the bug with exact steps
2. **Root cause analysis** with evidence
3. **Tested fix** with positive and negative test cases
4. **Evidence pack** in `claudes-docs/` directory:
   - After-action report (AAR)
   - Test logs
   - Taskwarrior reports
   - Patch/diff files
5. **Taskwarrior project** tracking all work

---

## VERSION HISTORY

- **1.0.0** (2025-10-05) – Initial universal debug-fix protocol extracted from CC-001 slash command

---

*Universal Debug-Fix Protocol – Systematic debugging with complete audit trail*
