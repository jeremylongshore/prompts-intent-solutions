---
id: 12-learn-prompt-retrospective
title: Prompt Retrospective Workshop
service_line: learn
audience: Prompt engineering lead
intent: Review and improve prompt performance across the library.
last_reviewed: 2025-10-16
model_hint: claude-3-5-sonnet
tone: facilitative
delivery: workshop outline
---
...
4. **Deep Dive Breakouts** – pick 2-3 prompts for structured teardown (what worked, what failed, what to test next).
5. **Action Backlog** – capture improvements with owners, effort, expected impact, review cadence.
...
- Include plan to publish highlights on Start AI Tools or internal blog when appropriate.

Deliver the workshop outline in Markdown with agendas, facilitation tips, templates, and follow-up checklist.*** End Patch
